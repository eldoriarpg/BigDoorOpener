...
public final class Permissions {
    ...
    // permission to access the item block condition
    public static final String ITEM_BLOCK_CONDITION = "bdo.condition.item.block";
    // permission to access the item block condition
    public static final String ITEM_CLICK_CONDITION = "bdo.condition.item.click";
    // permission to access the item holding condition
    public static final String ITEM_HOLDING_CONDITION = "bdo.condition.item.";
    // permission to access the item owning condition
    public static final String ITEM_OWNING_CONDITION = "bdo.condition.item.";
    // permission to access the proximity condition
    public static final String PROXIMITY_CONDITION = "bdo.condition.location.proximity";
    // permission to access the region condition
    public static final String REGION_CONDITION = "bdo.condition.location.region";
